...
namespace SalesWebMvc.Data {
    public class SeedingService {
        ...
        public void Seed() {
            ...
            Department d1 = new Department(1, "Hunters");
            Department d2 = new Department(2, "Demons");
            Department d3 = new Department(3, "Monsters");
            Department d4 = new Department(4, "Holys");

            Seller s1 = new Seller(1, "Bob Singer", "bobhunter@supernatural.com", new DateTime(1978, 4, 21), 3200, d1);
            Seller s2 = new Seller(2, "Dean Winchester", "deanw@supernatural.com", new DateTime(1990, 5, 12), 3200, d1);
            Seller s3 = new Seller(3, "Castiel", "castielfrufru@supernatural.com", new DateTime(1487, 2, 2), 4200, d4);
            Seller s4 = new Seller(4, "Crowley", "kingofhell@supernatural.com", new DateTime(1781, 7, 14), 4500, d2);
            Seller s5 = new Seller(5, "Lucifer", "tinhoso@supernatural.com", new DateTime(1000, 3, 1), 4500, d4);
            Seller s6 = new Seller(6, "Metamorpho", "metaumbulante@supernatural.com", new DateTime(1901, 2, 26), 4500, d3);
